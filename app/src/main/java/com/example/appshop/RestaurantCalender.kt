...
class RestaurantAccountInfoShow : AppCompatActivity() {
    ...
    private var client = GetHoloidayInfoWsClient(this, uri)

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_restaurant_calender)
        client.connect()
    }
    ...
    override fun onResume() {
        ...
        val buttonAccountAddHoliday = findViewById(R.id.buttonAccountAddHoliday)
        val buttonAccountDeleteHoliday = findViewById(R.id.buttonAccountDeleteHoliday)
