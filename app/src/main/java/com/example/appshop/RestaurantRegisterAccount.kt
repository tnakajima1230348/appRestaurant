...
class RestaurantRegisterAccount : AppCompatActivity() {
    companion object{
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_restaurant_register_account)
    }
...
class RegisterWsClient(private val activity: Activity, uri: URI) : WsClient(uri){
    ...
    override fun onMessage(message: String?) {
        ...
        if(resId == RestaurantRegisterAccount.registerReqId){
            ...
            if(status == "success"){
                ...
                activity.runOnUiThread{
                    if(reason == "restaurant_name has already taken by other restaurant"){
